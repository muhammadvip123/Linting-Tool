...
def get_in_out_signal_names(file: str) -> tuple[list, list, list, list, list, list, list, list, list]:
    input_signals = []
    inputs_types = []
    input_size = []
    output_signals = []
    ...
    with open(file, 'r') as f:
        for line in f:
            ...
            matches_internal = re.search("(wire|logic|reg)\s+", line)
    ...
    return input_signals, inputs_types, input_size, output_signals, output_types, output_size, internal_signals, internal_types, internal_size
        ...
        for line in f:
            ...
            if parametersfound or notdone:
                ...
                for parameter in parameters:
                    ...
                    cons_type = re.search(r"'(d|b|h)", parameter[1]).group()
